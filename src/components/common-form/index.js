            ...
            case 'input':
                content = <div className="relative flex items-center mt-8">
                    <Input 
                        ...
                        className="w-full rounded-md h-[60px] px-4 border bg-gray-100 text-lg outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus:bg-white focus:drop-shadow-lg focus-visible:outline-none"
                    />
                </div>
                break;
                case "file":
                        content = <Label
                            ...
                            className="flex bg=gray=100 item-center px-3 py-3 mx-auto mt-6 text-center border-2 border-dashed rounded-lg cursor-pointer"
                        >
