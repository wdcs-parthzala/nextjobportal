...
export default function AccountInfo({profileInfo}){
    ...
    useState(initialCandidateAccountFormData);
    ...
    console.log("can , req = ", candidateFormData, recruiterFormData)
    ...
    async function handleUpdateAccount(){
        await updateProfileAction(profileInfo?.role === 'candidate' ? {
            ...
            memberShipType:profileInfo?.memberShipType, memberShipStartDate:profileInfo?.memberShipStartDate ,memberShipEndDate: profileInfo?.memberShipEndDate,
            candidateInfo: {
                ...candidateFormData,
